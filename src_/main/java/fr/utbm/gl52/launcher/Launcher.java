...
public class Launcher {
	...
	public static void main(String[] argv) {
		...
		//File modelFile = new File("models/modelReceipt01.csv");
		File modelFile = new File("models/modelFactureShoe.csv");
		...
		//TextExtractor te = new TextExtractor("ImageTest/receipt01.png");
